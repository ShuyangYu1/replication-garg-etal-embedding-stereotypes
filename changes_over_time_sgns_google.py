...
def main(filenames, label, csvname = None, neutral_lists = [], group_lists = ['male_pairs', 'female_pairs'], do_individual_group_words = False, do_individual_neutral_words = False, do_cross_individual = False):
    ...
    with open('run_results/' + csvname, 'a', newline='', encoding='utf-8') as cf:
...
filename_map = {'sgns' : filenames_sgns, 'google':filenames_google}

if __name__ == "__main__":
    param_filename = 'run_params_sgns_google.csv'
    ...
    with open(param_filename,'r') as f:
        ...
        for row in reader:
            ...
            do_individual_neutral_words = (row['do_individual_neutral_words'].upper() == "TRUE")
            do_individual_group_words = (row.get('do_individual_group_words', '').upper() == "TRUE")
